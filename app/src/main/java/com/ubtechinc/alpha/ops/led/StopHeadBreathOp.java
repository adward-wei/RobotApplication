...
import com.ubtechinc.alpha.cmds.header.StopHeadBreathCmd;
...
public class StopHeadBreathOp extends BaseLedOp {

    public StopHeadBreathOp() {
        super(NOR_PRIORITY);
    }
    ...
    protected SerialCommand createCmd(SerialCommandReceiver receiver) {
        return new StopHeadBreathCmd(receiver);
    }

...
import com.ubtechinc.alpha.cmds.header.SetHeadHorseCmd;
...
public class SetHeadMarqueeOp extends BaseLedOp {
    ...
    protected SerialCommand createCmd(SerialCommandReceiver receiver) {
        return new SetHeadHorseCmd(receiver, color, bright, rled, lled, on, total);
    }

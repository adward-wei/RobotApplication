...
//				}
	...
	public static String parseTextUnderstand(String json) {
		StringBuffer ret = new StringBuffer();
		try {
			JSONTokener tokener = new JSONTokener(json);
			JSONObject joResult = new JSONObject(tokener);
			...
			JSONObject items = joResult.getJSONObject("answer");
			String ss = items.getString("text");
			ret.append(ss);
	...
	public static String parseString(String json) {
		...
		try {
			...
			//JSONObject items = joResult.getJSONObject("answer");
			//String ss = items.getString("text");
			String ss = joResult.getString("translation");
			...
			if(strs != null && strs.length > 0) {
				...
				if(strs.length == 1) {
					...
					if(strs2 != null && strs2.length > 1) {
						ret.append(strs2[strs2.length - 1]);
					} else {

...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		switch (message.what) {
		case MessageId.restart_preview:
			restartPreviewAndDecode();
			break;
		case MessageId.decode_succeeded:
			state = State.SUCCESS;
		...
		case MessageId.decode_failed:
			...
			cameraManager.requestPreviewFrame(decodeThread.getHandler(),
					MessageId.decode);
			break;
		case MessageId.return_scan_result:
			activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
			activity.finish();
			break;
		case MessageId.launch_product_query:
	...
	public void quitSynchronously() {
		...
		Message quit = Message
				.obtain(decodeThread.getHandler(), MessageId.quit);
		quit.sendToTarget();
		try {

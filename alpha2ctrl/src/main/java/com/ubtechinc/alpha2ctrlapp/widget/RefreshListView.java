...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(
				R.layout.refresh_listview, null);
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_To_REFRESH:
			...
			tipsTextview.setText(R.string.list_pull_to_refresh_release_label);
			Log.v(TAG, "当前状态，松开刷新");
			break;
		case PULL_To_REFRESH:
			...
			if (isBack) {
				...
				tipsTextview.setText(R.string.list_pull_to_refresh_pull_label);
			} else {
				tipsTextview.setText(R.string.list_pull_to_refresh_pull_label);
			}
			Log.v(TAG, "当前状态，下拉刷新");
		...
		case REFRESHING:
			...
			tipsTextview.setText(R.string.list_more);
			lastUpdatedTextView.setVisibility(View.VISIBLE);
			Log.v(TAG, "当前状态,正在刷新...");
			break;
		case DONE:
...
//		lastUpdatedTextView.setText("最近更新:" + date);
	...
	public View getSearch_lay() {
		return search_lay;
	}

	public void setSearch_lay(View search_lay) {
		this.search_lay = search_lay;
	}

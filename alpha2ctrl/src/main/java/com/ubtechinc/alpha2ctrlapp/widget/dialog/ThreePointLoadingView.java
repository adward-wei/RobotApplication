...
public class ThreePointLoadingView extends View {
	...
	private void init() {
        ...
        mBallPaint.setColor(0x008ab9dc);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 考虑padding值
        mWidth = measureSize(widthMeasureSpec, SizeUtils.dp2px(120)) + getPaddingLeft() + getPaddingRight();
        mHeight = measureSize(heightMeasureSpec, SizeUtils.dp2px(120)) + getPaddingTop() + getPaddingBottom();

        setMeasuredDimension(mWidth, mHeight);

        // 间距为宽度10分之一
        mSpace = mWidth * 1.0f / 15;

        // 半径为宽度50分之一
        mBallRadius = mWidth * 1.0f / 20;

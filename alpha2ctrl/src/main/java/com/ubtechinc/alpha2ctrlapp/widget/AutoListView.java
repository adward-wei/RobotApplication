...
public class AutoListView extends ListView implements OnScrollListener {
	...
	public void onRefresh() {
		boolean bTimeOut = Math.abs(SystemClock.uptimeMillis()
				- mlLastClickTime) > 1000 ? true : false;
	...
	public void onRefreshComplete(String updateTime) {
		lastUpdate.setText(this.getContext().getString(R.string.list_lastUpdateTime,
	...
	public void onRefreshComplete() {
		String currentTime = TimeUtils.getCurrentTimeInString(TimeUtils.DEFAULT_DATE_FORMAT);
	...
	private void refreshHeaderViewByState() {
		...
		case NONE:
			topPadding(-headerContentHeight);
			tip.setText(R.string.list_pull_to_refresh);
			refreshing.setVisibility(View.GONE);
			arrow.clearAnimation();
			arrow.setImageResource(R.drawable.bluearrowup);
			break;
		case PULL:
		...
		case RELEASE:
			...
			refreshing.setVisibility(View.GONE);
			tip.setText(R.string.list_pull_to_refresh);
			tip.setText(R.string.list_release_to_refresh);
			arrow.clearAnimation();

...
public class SwtichChangeListButton extends LinearLayout implements OnClickListener{
	...
	public SwtichChangeListButton(Context context) {
		super(context);
	...
	public SwtichChangeListButton(Context context, AttributeSet attrs) {
		super(context, attrs);

...
public class SearchRefreshListView extends ListView implements OnScrollListener {
	...
	public SearchRefreshListView(Context context) {
		super(context);
		init(context);
	}
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.refresh_listview, null);

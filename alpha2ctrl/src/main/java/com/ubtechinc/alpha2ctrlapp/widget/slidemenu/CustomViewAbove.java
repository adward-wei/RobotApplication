package com.ubtechinc.alpha2ctrlapp.widget.slidemenu;
...
//			if(memuImage!=null) {
//					this.memuImage.setImageResource(R.drawable.top_menu_close);
//				}
		} else {
//			if(memuImage!=null) {
//				this.memuImage.setImageResource(R.drawable.top_menu_open);
//			}
			completeScroll();
			scrollTo(destX, 0);
	...
	public ImageView getMemuImage() {
		return memuImage;
	}

	public void setMemuImage(ImageView memuImage) {
		this.memuImage = memuImage;
	}

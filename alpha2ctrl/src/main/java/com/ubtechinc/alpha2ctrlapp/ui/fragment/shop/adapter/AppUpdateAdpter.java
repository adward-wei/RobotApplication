...
public class AppUpdateAdpter extends BaseAdapter implements OnItemClickListener {
    ...
    public View getView(final int position, View convertView, ViewGroup arg2) {
        ...
        if (!RobotManagerService.getInstance().isConnectedRobot()       || TextUtils.isEmpty(appInfoList.get(position).getAppPath())) {
        ...
        viewHolder.btn_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                    ...
                    if (appInfoList.get(position).getStatus() == BusinessConstants.APP_STATE_INIT
                            || appInfoList.get(position).getStatus() == BusinessConstants.APP_STATE_DOWNLOAD_FAIL
                            || appInfoList.get(position).getStatus() == BusinessConstants.APP_STATE_INSTALL_FAIL || appInfoList.get(position).getStatus() == 7) {

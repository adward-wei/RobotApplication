...
public final class Alarm implements Parcelable {
	...
	public static class Columns implements BaseColumns {
		...
		public static final Uri CONTENT_URI = Uri
				.parse("content://com.ubtechinc.alarm_info/alarm_info_table");
		...
		public static final int ALARM_DTSTART_INDEX = 9;
		public static final int ALARM_ISCOMPLETE_INDEX = 10;
		public static final int ALARM_DTTIME_INDEX = 11;
	}
	...
	public String toString() {
		...
		return "" + id + " " + hour + " " + minutes + " "
				+ daysOfWeek.getCoded() + " " + time + " " + vibrate + " "
				+ label + " dtstart =" + dtstart + " iscomplete " + iscomplete
				+ " dttime " + dttime;
	}
	...
	public Alarm(Cursor c) {
		...
		dtstart = c.getLong(Columns.ALARM_DTSTART_INDEX);
		iscomplete = c.getInt(Columns.ALARM_ISCOMPLETE_INDEX) == 1;
		dttime = c.getLong(Columns.ALARM_DTTIME_INDEX);
	...
	public Alarm(Parcel p) {
		...
		vibrate = p.readInt() == 1;
		label = p.readString();
		alert = p.readParcelable(getClass().getClassLoader());
		silent = p.readInt() == 1;
	}

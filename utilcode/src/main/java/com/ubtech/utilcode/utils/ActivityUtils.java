...
public class ActivityUtils {
    ...
    public static void replaceFragment(@NonNull Activity activity,@NonNull FragmentManager fragmentManager,String fragmentClassName,  int frameId, Bundle args) {
        Fragment fragment = fragmentManager.findFragmentByTag(fragmentClassName);
        if (fragment == null) {
            fragment = Fragment.instantiate(activity, fragmentClassName);
        }
        fragment.setArguments(args);
        FragmentTransaction ft = fragmentManager.beginTransaction();
        ft.replace(frameId, fragment, fragmentClassName);
        ft.addToBackStack(fragmentClassName);

        slidingKeyBroad(activity);
        ft.commit();
    }


    public static void replaceFragment(@NonNull Activity activity, @NonNull FragmentManager fragmentManager, Fragment contentFragment, int frameId ) {

        FragmentTransaction ft = fragmentManager.beginTransaction();
        ft = fragmentManager.beginTransaction();
        ft.replace(frameId, contentFragment);
     ...
     * 收起键盘
     */
    public static void slidingKeyBroad(Activity activity){

...
import static com.ubtech.utilcode.utils.RegexUtils.*;
...
public class RegexUtilsTest {
    ...
    public void testIsEmail() throws Exception {
        assertThat(isEmail("logic.peng@qq.com")).isTrue();
        assertThat(isEmail("logic.peng@qq")).isFalse();
    }

    @Test
    public void testIsURL() throws Exception {
        assertThat(isURL("http://www.baidu.com")).isTrue();
    ...
    public void testGetMatches() throws Exception {
        // 贪婪
        System.out.println(getMatches("b.*j", "logic.peng logic.peng"));
        // 懒惰
        System.out.println(getMatches("b.*?j", "logic.peng logic.peng"));
    }
